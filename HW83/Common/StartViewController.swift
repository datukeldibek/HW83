...
class StartViewController: UIViewController {
    ...
    private let images: [String] = ["person1", "person2", "person3", "person4", "person5", "person6"]
    ...
    private func initData() {
        users = ["Datkayim", "Bakdoolot", "Hanzat", "Hanzaman", "Meerim", "datu"]
    }
